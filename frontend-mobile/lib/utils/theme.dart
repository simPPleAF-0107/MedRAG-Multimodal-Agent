...
class MedRagTheme {
  // Eye-Catching Vibrant Dark Palette (Enterprise Obsidan & Cyan)
  static const Color backgroundDark = Color(0xFF0A0A0A); // Obsidian
  static const Color surfaceDark = Color(0xFF111111); // Elevation 1
  static const Color primaryCyan = Color(0xFF00D4FF); // Clinical Cyan
  ...
  static const Color errorRed = Color(0xFFFF4567);
  static const Color successGreen = Color(0xFF10E8A0);
